...
/-- Filter atoms for the view: not hidden, never lean-generated or aeneas-generated
    (dropped regardless of `is-hidden`), relevant, and code-path ends with `Funs.lean`. -/
