...
/-- Determine why an atom is trusted, if at all. Priority:
    axiom > external > auto-generated. Atoms without source location
    are auto-generated by the Lean kernel and guaranteed sound. -/
def trustedReason (atom : Atom) : Option String :=
  ...
  else if atom.codeText.isNone then some "auto-generated"
  else none
